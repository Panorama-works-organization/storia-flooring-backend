...
<html lang="es">
    <head>
        <title>[Zépika] Se recibió el pago de #{{ $data['order_number'] }}</title>
  ...
  <title>Se recibió el pago de #{{ $data['order_number'] }} </title>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <meta name="viewport" content="width=device-width">
              ...
              <table class="row" style="width: 100%; border-spacing: 0; border-collapse: collapse;">
                <tbody><tr>
                  <td class="shop-name__cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;">
                      <img src="https://cdn.shopify.com/s/files/1/0665/4636/8751/files/Zepika-Logo.png?14069" alt="Zépika" width="99">
                  </td>
      ...
      <center>
        <table class="container" style="width: 560px; text-align: left; border-spacing: 0; border-collapse: collapse; margin: 0 auto;">
          <tbody><tr>
            ...
            <h2 style="font-weight: normal; font-size: 24px; margin: 0 0 10px;">Se recibió el pago de #{{ $data['order_number'] }} </h2>
  ...
  <tr>
    <td class="actions__cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;">
      <table class="button main-action-cell" style="border-spacing: 0; border-collapse: collapse; float: left; margin-right: 15px;">
        <tbody><tr>
          <td class="button__cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; border-radius: 4px;" align="center" bgcolor="#101010"><a href="{{$data['order_status_url']}}" class="button__text" style="font-size: 16px; text-decoration: none; display: block; color: #fff; padding: 20px 25px;">Ver tu pedido</a></td>
        </tr>
      </tbody></table>
      
    <table class="link secondary-action-cell" style="border-spacing: 0; border-collapse: collapse; margin-top: 19px;">
      <tbody><tr>
        <td class="link__cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; border-radius: 4px;" align="center">o <a href="https://zepika.com/" style="font-size: 16px; text-decoration: none; color: #101010;">Visita nuestra tienda</a>
</td>
      </tr>
    </tbody></table>
    ...
    <td class="section__cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding: 40px 0;">
      <center>
        <table class="container" style="width: 560px; text-align: left; border-spacing: 0; border-collapse: collapse; margin: 0 auto;">
          <tbody><tr>
            <td style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;">
              <h3 style="font-weight: normal; font-size: 20px; margin: 0 0 25px;">Resumen del pedido</h3>
            </td>
          </tr>
        </tbody></table>
        <table class="container" style="width: 560px; text-align: left; border-spacing: 0; border-collapse: collapse; margin: 0 auto;">
                    ...
                    <td class="order-list__item__cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding-bottom: 15px;">
                        <table style="border-spacing: 0; border-collapse: collapse;">
                            <tbody>
                                <tr>
                                    <td style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;">
                                        <img src="{{$product['image']}}" align="left" width="60" height="60" class="order-list__product-image" style="margin-right: 15px; border-radius: 8px; border: 1px solid #e5e5e5;">
                                    </td>
                                    <td class="order-list__product-description-cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; width: 100%;">
                                        <span class="order-list__item-title" style="font-size: 16px; font-weight: 600; line-height: 1.4; color: #555;">{{$product['name']}} &nbsp;&times;&nbsp; {{ $product['quantity'] }}</span><br>
                                    </td>
...
<tbody>
    @if(count($data['discount_applications']) > 0)
    @foreach ($data['discount_applications'] as $discount_application)
        @php
            $discount_title = null;
            if($discount_application['target_selection'] == 'all'){
                $discount_title = $discount_application['title'];
            }else{
                $discount_title = 'Descuento';
            }
        @endphp
        <tr class="subtotal-line">
        <td class="subtotal-line__title" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding: 2px 0;">
            <p style="color: #777; line-height: 1.2em; font-size: 16px; margin: 0;">
            <span style="font-size: 16px;">Descuento</span>
                <span class="subtotal-line__discount" style="font-size: 16px; margin-left: 5px;">
                <img src="https://cdn.shopify.com/shopifycloud/shopify/assets/themes_support/notifications/discounttag-d1f7c6d9334582b151797626a5ae244c56af0791fcd7841f21027dd44830bcc6.png" width="18" height="18" class="discount-tag-icon" style="vertical-align: middle; margin-right: 6px;">
                <span class="subtotal-line__discount-title" style="font-size: 16px; margin-left: -4px;">
        ...
        <td class="subtotal-line__value" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding: 2px 0;" align="right">
            <strong style="font-size: 16px; color: #555;">
                -$ {{number_format($discount_application['total_allocated_amount'],2)}}
            </strong>
        </td>
        </tr>
    @endforeach
...
<tr class="subtotal-line">
  ...
  <td class="subtotal-line__value" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding: 2px 0;" align="right">
    <strong style="font-size: 16px; color: #555;">$ {{ number_format($data['subtotal_price'], 2) }}</strong>
  </td>
</tr>
...
<tr class="subtotal-line">
  <td class="subtotal-line__title" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding: 2px 0;">
    <p style="color: #777; line-height: 1.2em; font-size: 16px; margin: 0;">
      <span style="font-size: 16px;">Envíos</span>
    </p>
  </td>
  <td class="subtotal-line__value" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding: 2px 0;" align="right">
    <strong style="font-size: 16px; color: #555;">$ 
        {{ number_format($data['total_shipping_price_set']['shop_money']['amount'], 2) }}
    </strong>
  </td>
</tr>
...
<tr class="subtotal-line">
  <td class="subtotal-line__title" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding: 2px 0;">
    <p style="color: #777; line-height: 1.2em; font-size: 16px; margin: 0;">
      <span style="font-size: 16px;">Impuestos</span>
    </p>
  </td>
  <td class="subtotal-line__value" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding: 2px 0;" align="right">
    <strong style="font-size: 16px; color: #555;">$ {{ number_format($data['total_tax'], 2) }}</strong>
  </td>
</tr>
...
<tbody><tr class="subtotal-line">
  ...
  <td class="subtotal-line__value" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding: 20px 0 0;" align="right">
    <strong style="font-size: 24px; color: #555;">$ 
        {{number_format($data['total_price_set']['shop_money']['amount'], 2). ' '. $data['total_price_set']['shop_money']['currency_code']}} 
    </strong>
  </td>
</tr>
        ...
        @if ($data['total_discounts'] > 0)
            <p class="total-discount" style="color: #777; line-height: 1.1; font-size: 16px; margin: 10px 0 0;" align="right">
          Ahorraste <span class="total-discount--amount" style="font-size: 16px; color: #555;">$ {{ number_format($data['total_discounts'], 2) }}</span>
        </p>
        @endif
        ...
        <table class="row subtotal-table" style="width: 100%; border-spacing: 0; border-collapse: collapse; margin-top: 20px;">
          <tbody><tr><td colspan="2" class="subtotal-table__line" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; border-bottom-width: 1px; border-bottom-color: #e5e5e5; border-bottom-style: solid; height: 1px; padding: 0;"></td></tr>
          <tr><td colspan="2" class="subtotal-table__small-space" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; height: 10px;"></td></tr>
          ...
          <tbody><tr>
            ...
            <table class="row" style="width: 100%; border-spacing: 0; border-collapse: collapse;">
              <tbody><tr>
                @if ($require_shipping)
                  ...
                  <h4 style="font-weight: 500; font-size: 16px; color: #555; margin: 0 0 5px;">Dirección de envío</h4>
                  <p style="color: #777; line-height: 150%; font-size: 16px; margin: 0;">
                    
                    {{$data['shipping_address']['first_name'].' '.$data['shipping_address']['last_name']}}<br>
                    @isset($data['shipping_address']['company'])
                        {{ $data['shipping_address']['company'] }}<br>
                    @endisset
                    @isset($data['shipping_address']['address1'])
                        {{ $data['shipping_address']['address1'] }}<br>
                    @endisset
                    @isset($data['shipping_address']['address2'])
                        {{ $data['shipping_address']['address2'] }}<br>
                    @endisset
                    @isset($data['shipping_address']['city'])
                        {{ $data['shipping_address']['city'] }}, {{ $data['shipping_address']['zip'] }}<br>
                    @endisset
                    @isset($data['shipping_address']['country'])
                ...
                <td class="customer-info__item" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding-bottom: 40px; width: 50%;" valign="top">
                  <h4 style="font-weight: 500; font-size: 16px; color: #555; margin: 0 0 5px;">Dirección de facturación</h4>
                  <p style="color: #777; line-height: 150%; font-size: 16px; margin: 0;">
                    
                    {{$data['billing_address']['first_name'].' '.$data['billing_address']['last_name']}}<br>
                    @isset($data['billing_address']['company'])
                        {{ $data['billing_address']['company'] }}<br>
                    @endisset
                    @isset($data['billing_address']['address1'])
                        {{ $data['billing_address']['address1'] }}<br>
                    @endisset
                    @isset($data['billing_address']['address2'])
                        {{ $data['billing_address']['address2'] }}<br>
                    @endisset
                    @isset($data['billing_address']['city'])
                        {{ $data['billing_address']['city'] }}, {{ $data['billing_address']['zip'] }}<br>
                    @endisset
                    @isset($data['billing_address']['country'])
            ...
            <table class="row" style="width: 100%; border-spacing: 0; border-collapse: collapse;">
              <tbody><tr>
                ...
                <td class="customer-info__item" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding-bottom: 40px; width: 50%;" valign="top">
                    <h4 style="font-weight: 500; font-size: 16px; color: #555; margin: 0 0 5px;">Método de pago</h4>
                    <p style="color: #777; line-height: 150%; font-size: 16px; margin: 0;">{{ $data['gateway'] }}</p>
                  </td>
              ...
              <tr>
                  ...
                  @if ($require_shipping)
                  <td class="customer-info__item" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; padding-bottom: 40px; width: 50%;" valign="top">
                    <h4 style="font-weight: 500; font-size: 16px; color: #555; margin: 0 0 5px;">Método de envío</h4>
        ...
        <table class="container" style="width: 560px; text-align: left; border-spacing: 0; border-collapse: collapse; margin: 0 auto;">
          <tbody><tr>
            <td style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;">
              ...
              <p class="disclaimer__subtext" style="color: #999; line-height: 150%; font-size: 14px; margin: 0;">Si tienes alguna pregunta, responde este correo electrónico o contáctanos a través de <a href="mailto:contacto@zepika.com" style="font-size: 14px; text-decoration: none; color: #101010;">contacto@zepika.com</a></p>
            </td>
          </tr>
        </tbody></table>
      </center>
